...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"C:\Users\Amirtha\Desktop\Project_Deployment_Resume\skills.csv") # reading the csv file
...
# MAIN CODE
import pickle as pk
model = pk.load(open(r"C:\Users\Amirtha\Desktop\Project_Deployment_Resume\modelDT2.pkl", 'rb'))
Vectorizer = pk.load(open(r"C:\Users\Amirtha\Desktop\Project_Deployment_Resume\vector2.pkl", 'rb'))
